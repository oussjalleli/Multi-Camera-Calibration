...
class Board(object):
  ...
  def estimate_pose_points(self, camera, detections):
    raise NotImplementedError()
""" This code defines an abstract base class Board, which serves as a blueprint for specific types of calibration boards like the AprilGrid or CharucoBoard"""